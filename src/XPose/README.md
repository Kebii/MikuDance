...
python inference_on_videos.py -c config_model/UniPose_SwinT.py -p weights/unipose_swint.pth -i /data/midjourney/zhangjiaxu/datasets/2D_anime_test/MV-resize -o /data/midjourney/zhangjiaxu/datasets/temp/uniface-MV-resize -t "face" -k "face"
python inference_on_image.py -c config_model/UniPose_SwinT.py -p weights/unipose_swint.pth -i /data/midjourney/zhangjiaxu/datasets/temp/test_chars/ying1.png -o /data/midjourney/zhangjiaxu/datasets/temp/test_chars -t "face" -k "face"